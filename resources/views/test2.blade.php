...
<!-- <script>
  ...
  (function(d, s, id){
        ...
        <div class="steps-form mt-5">
          <div class="steps-row setup-panel">
            <div class="steps-step">
              <a href="{{ route('streaming.moyen_payment', $stream) }}" type="button" class="btn btn-success btn-circle">1</a>
              <p>Moyen</p>
            </div>
            <div class="steps-step">
    ...
    <main>
      <form  class="form-signin d-flex flex-column bd-highlight" action="{{ route('streaming.payment-proof-store', ['choice' => $choice, 'stream' => $stream]) }}" method="post">
        @csrf
                ...
                <div class="media-body">
                  <div class="row align-items-center">
                    <div class="col-sm mb-1 mb-sm-0">
                      <h6 class="mb-1 text-muted">Total à payer : </h6>
                      <h3>{{ $stream->forfait_price }} Fcfa</h3>
                      <!-- <a href="" class="btn bg-success btn-circle">
                        <i data-feather="check" stroke-width="2.5" width="16" height="16"></i>
                      </a> -->
                    </div>
                  </div>
                </div>
      ...
      <div class="card card-body shadow my-3">
            ...
            <div class="media">
              <div class="media-body">
                <div class="row align-items-center">
                  <div class="col-sm mb-1 mb-sm-0">
                    @if($choice == "byPhone")
                      <h6 class="mb-2 text-muted">Numéro de téléphone : </h6>
                      <input type="text" class="form-control @error('proof') is-invalid @enderror" name="proof" value="">
                      <small>Entrez le numéro avec lequel vous avez effectuer le transfert </small>
                      @error('proof')
                    ...
                    @elseif($choice == "byAgent")
                      ...
                      <h6 class="mb-2 text-muted">Code de l'agent : </h6>
                      <input type="text" class="form-control @error('proof') is-invalid @enderror" name="proof" value="">
                      <small>Entrez le code Airtel Money de l'agent chez qui vous avez effectuer le transfert </small>
                      @error('proof')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
            ...
            <div class="list-group-item">
              <div class="media">
                <div class="media-body">
                  <div class="row align-items-center">
                    <div class="col-sm mb-1 mb-sm-0">
                      <h6 class="mb-1 text-muted">Envoyer le montant au : </h6>
                      <span class="h4">074-87-83-17</span>
                    </div>
                    <div class="col-sm">
                       <span class="text-danger">Faites le transfert avant de continuer. </span>
                    </div>
                  </div>
        ...
        <!-- <div class="form-group mt-4">
          <label for="code">Numéro de transfert</label>
        ...
        @endif -->
        <div class="row p-3">
          <a href="{{ route('streaming.moyen_payment', $stream) }}" class="mr-auto btn btn-lg btn-flat">
            <i data-feather="arrow-left" stroke-width="3" width="16" height="16"></i>
            <span class="text-icon">Retour</span>
          </a>
          <button  id="soumi"  class="btn bd-highlight mt-auto btn-primary ml-auto btn-lg  my-4 font-weight-bold" type="submit">
