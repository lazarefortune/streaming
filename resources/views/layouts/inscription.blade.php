...
<html lang="fr">
  <head>
    ...
    <title>Web Creation · Inscription</title>
  ...
  (function(d, s, id){
     ...
     fjs.parentNode.insertBefore(js, fjs);
        ...
        <form class="form-signin" method="POST" action="{{ route('register') }}">
          ...
          <h3 class="text-center font-weight-bold mt-5 mt-sm-5 mt-lg-0 mb-4" style="color: #677987 !important;">Inscription</h3>
          ...
          <div class="p-4">
            <a href="{{ route('login') }}"  class="btn btn-success btn-block" type="button" name="button">
