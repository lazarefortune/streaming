    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 col-12">
        ...
        <div class="card card-fluid my-3">
          <!-- <h6  class="card-header"> <i data-feather="lock" width="20" height="20"></i> <b  class="text-icon">Sécurité</b> </h6> -->
          <div class="card-body">
            <div class="row">
              <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                <h5>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                ...
                <p style="font-size: 14px;">Ces informations peuvent nous permettre de vérifier votre identité au moment de la connexion ou de vous contacter en cas d'activité suspecte sur votre compte.</p>
              </div>
              <div class="col-lg-4 col-md-4 d-none d-sm-none d-md-block d-lg-block">
